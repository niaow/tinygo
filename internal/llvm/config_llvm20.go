...
#cgo darwin,amd64 LDFLAGS: -L/usr/local/opt/llvm@20/lib -lLLVM-20
#cgo darwin,arm64 LDFLAGS: -L/opt/homebrew/opt/llvm@20/lib -lLLVM-20
#cgo freebsd      LDFLAGS: -L/usr/local/llvm20/lib -lLLVM-20
*/
import "C"
