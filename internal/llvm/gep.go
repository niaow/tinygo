...
// GEPMode is used to specify the flag set to attach to a GEP.
// This is structured as a flat enum because only some combinations are valid.
//
// https://llvm.org/docs/LangRef.html#getelementptr-instruction
...
const (
	...
	//
	// This is converted to GEPInbounds for compatibility when using LLVM 18 and below.
	...
	//
	// This is converted to GEPWrapping for compatibility when using LLVM 18 and below.
	...
	// This is the default behavior of GEP without any flags.
	GEPWrapping GEPMode = C.LLVMGoGEPWrapping
)

// String formats the GEP mode in a format which resembles the flag set in IR.
// It may not exactly match the format printed in IR.
func (mode GEPMode) String() string {
	return gepModeNames[mode]
}

var gepModeNames = [...]string{
	GEPInboundsForwards: "inbounds nuw",
	GEPInbounds:         "inbounds",
	GEPForwards:         "nusw nuw",
	GEPSigned:           "nusw",
	GEPUnsigned:         "nuw",
	GEPWrapping:         "wrapping",
}
